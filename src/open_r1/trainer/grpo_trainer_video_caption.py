...
# """
class Qwen2VLGRPOTrainer_Video_Caption_nothink(Trainer):
    """
    ...
    def make_conversation_video(self, example):
        ...
        example_prompt=example["problem"]["question"]
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        with unwrap_model_for_generation(model, self.accelerator) as unwrapped_model:
            ...
            if 'second_per_grid_ts' in prompt_inputs and isinstance(prompt_inputs['second_per_grid_ts'], torch.Tensor):
                prompt_inputs['second_per_grid_ts'] = prompt_inputs['second_per_grid_ts'].tolist()
